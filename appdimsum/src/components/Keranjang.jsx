...
const Keranjang = ({ visible, onClose }) => {
  ...
  const formattedTotalPrice = `Rp ${Math.max(
    0,
    totalPrice
  ).toLocaleString('id-ID')}`

  const trackingOrder = orders.find(
    (o) => o.id === trackingOrderId
  )

  const currentStatus =
    trackingOrder?.status || 'Menunggu Konfirmasi'
  ...
  const canClose =
    ...
    (!showTracking || currentStatus === 'Selesai')
  ...
  return (
    <div className="cart-overlay" onClick={handleOverlayClick}>
      {showSentNotification ? (
        ...
        <div
          className="cart-modal tracking-modal"
          onClick={stopClose}
        >
            ...
            {[
              {
                ...
                subtitle:
                  'Admin telah menyetujui pesanan Anda',
              },
              {
                label: 'Sedang Disiapkan',
                subtitle:
                  'Koki sedang meracik hidangan Anda',
              },
              {
              ...
              {cart.length === 0 ? (
                <div className="empty-cart-state">
                  ...
                  <p className="empty-desc">
                    Belum ada menu yang dipilih nih.
